package com.example.extra.global.websocket;

import com.example.extra.domain.dto.ChatMessageDto;
import com.example.extra.domain.entity.ChatRoom;
...
public class WebSocketHandler extends TextWebSocketHandler {
    ...
    protected void handleTextMessage(WebSocketSession session, TextMessage message) throws Exception {
        ...
        ChatRoom chatRoom = chatService.findRoomById(chatMessageDto.getChatId());
